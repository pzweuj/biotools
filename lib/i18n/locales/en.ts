export const en = {
  ...
  tools: {
    ...
    "blosum-matrix": {
      name: "BLOSUM Scoring Matrix",
      description: "Browse BLOSUM62 substitution scores and quickly locate the score for any amino acid pair",
      ...
      identityText: "Diagonal cells show scores for identical substitutions.",

export const en = {
  ...
  tools: {
    ...
    "sequencing-depth": {
      ...
      inputDataSizeHint: "Input actual sequencing data size (FASTQ file size)",
      results: "Results",
      ...
      formula: "Formula: Effective Depth = (Total Reads × Read Length × Capture Efficiency) / Target Size. Data size is estimated for FASTQ format.",
    },
    "codon-optimizer": {

export const en = {
  ...
  tools: {
    ...
    "base-complement": {
      ...
      description: "Calculate complement and reverse complement of DNA sequences",
      inputLabel: "Input DNA Sequence",
      inputPlaceholder: "Enter DNA sequence, e.g.: ATCGATCG",
      complement: "Get Complement",
      reverseComplement: "Get Reverse Complement",
      result: "Result",
      original: "Original",
      output: "Result",
    },
